...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Mid Fight Masses V1.0.0", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Mid Fight Masses V1.0.0");
end
